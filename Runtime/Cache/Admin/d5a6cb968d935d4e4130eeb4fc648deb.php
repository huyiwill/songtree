...
<html>
<head>
  <title>pigpigman(猪猪侠)管理系统</title>
...
<div class="panel-group" id="accordion">
  <?php if($webuser == $adminuser): ?><div class="panel panel-info">
      ...
      <div class="panel-heading" data-toggle="collapse" data-toggle="collapse" data-parent="#accordion"
           href="#collapseOne">网站基本信息设置
      </div>
  ...
  <div class="panel panel-info">
    <!-- Default panel contents -->
    <div class="panel-heading" data-toggle="collapse" data-toggle="collapse" data-parent="#accordion" href="#info">
      网站信息管理
    </div>
    <div class="panel-body panel-collapse collapse " id="info">
      <ul class="list-group">
        <li class="list-group-item"><a href="__GROUP__/Cate" target="right">分类管理</a></li>
        <li class="list-group-item"><a href="__GROUP__/Cate/addcate" target="right">添加分类</a></li>
        <li class="list-group-item"><a href="__GROUP__/Info" target="right">内容管理</a></li>
        <li class="list-group-item"><a href="__GROUP__/Info/addinfo" target="right">添加内容</a></li>
  ...
  <div class="panel panel-info">
    <!-- Default panel contents -->
    <div class="panel-heading" data-toggle="collapse" data-toggle="collapse" data-parent="#accordion" href="#seo">
      SEO专用功能
    </div>
  ...
  <div class="panel panel-info">
    <!-- Default panel contents -->
    <div class="panel-heading" data-toggle="collapse" data-toggle="collapse" data-parent="#accordion" href="#weixin">
      微信管理
    </div>
    <div class="panel-body panel-collapse collapse " id="weixin">

      <ul class="list-group">
        <li class="list-group-item"><a href="__GROUP__/Weixin/index" target="right">关注回复</a></li>
        <li class="list-group-item"><a href="__GROUP__/Weixin/keyhf" target="right">关键词回复</a></li>
  ...
  <div class="panel panel-info">
    <!-- Default panel contents -->
    <div class="panel-heading" data-toggle="collapse" data-toggle="collapse" data-parent="#accordion" href="#fujia">
      扩展功能
    </div>
    <div class="panel-body panel-collapse collapse " id="fujia">
      <p>联系:<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2468818839&site=qq&menu=yes"><img
        border="0" src="http://wpa.qq.com/pa?p=2:2468818839:52" alt="点击这里给我发消息" title="点击这里给我发消息"/></a><a
        target="_blank"
        href="http://wpa.qq.com/msgrd?v=3&uin=2468818839&site=qq&menu=yes"><img
        border="0" src="http://wpa.qq.com/pa?p=2:2468818839:52" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></p>
      <ul class="list-group">
        ...
        <li class="list-group-item"><a href="__GROUP__/Message/index" target="right">留言管理</a></li>
      </ul>
    </div>
  </div>
</div>
