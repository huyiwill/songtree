...
if(file_exists('../Conf/pigman.php')){
    header("Content-type: text/html; charset=utf-8");
    echo "你已经安装过了！要重装请删除Conf目录下的pigman.php";
    exit();
}
?>
...
<div class="panel">
  <div class="panel-heading">
    <img src="http://www.songtreehy.com/www/songtree/Uploads/mid/pig.jpg"/>
  </div>
  <div class="panel-body">
    ...
    <div class="panel-footer">声明：pigpigman <a
        href="http://wpa.qq.com/msgrd?v=3&uin=2468818839&site=qq&menu=yes">帮助</a></div>
  </div>
</div>
